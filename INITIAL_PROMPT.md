...
手動作成・task交代・旧taskが利用不能な場合も同じ通常startupを使用します。旧task ID、旧ownerの協力、activation、交代専用commitを要求しません。installed `scaffold-project-governance`は明示されたgovernance作成・採用・移行・更新の依頼だけで読み、通常作業では読みません。
