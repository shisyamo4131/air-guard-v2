...
<template>
  <v-container fluid class="pa-4">
    <v-row>
      <v-col cols="12">
        <h1 class="text-h4 mb-4">EmployeeTag</h1>
      </v-col>
    </v-row>
      ...
      <v-col cols="12">
        <v-card class="pa-4 mb-6">
          ...
          <v-row>
            ...
            <v-col cols="12" md="6">
              <h3 class="text-subtitle-2 mb-2">アラート付き従業員</h3>
              <EmployeeTag
                :doc-id="selectedEmployee.docId"
                :fetch-employee-composable="employeeComposable"
                size="medium"
            ...
            <v-col cols="12" md="6">
              <h3 class="text-subtitle-2 mb-2">新人従業員</h3>
              <EmployeeTag
                :doc-id="selectedEmployee.docId"
                :fetch-employee-composable="employeeComposable"
                size="medium"
    ...
    <v-row>
      <v-col cols="12">
        <v-card class="pa-4 mb-6">
          ...
          <v-row>
            <v-col cols="12" md="6">
              <h3 class="text-subtitle-2 mb-2">通常の従業員</h3>
              <EmployeeTag
                :doc-id="selectedEmployee.docId"
                :fetch-employee-composable="employeeComposable"
                size="medium"
            ...
            <v-col cols="12" md="6">
              <h3 class="text-subtitle-2 mb-2">時刻未定の従業員</h3>
              <EmployeeTag
                :doc-id="selectedEmployee.docId"
                :fetch-employee-composable="employeeComposable"
                size="medium"
