<script setup>
/*****************************************************************************
 * @file ./components/Outsourcer/Card/index.vue
 * @description 外注先カードコンポーネント
 * @author shisyamo4131
 *
 * @property {Outsourcer} outsourcer - 表示する外注先のデータ
...
const props = useDefaults(_props, "OutsourcerCard");
  ...
  <v-card>
    ...
    >
      <v-btn
        ...
        icon="mdi-pencil"
        size="small"
        @click="emit('click:edit', props.outsourcer)"
      />
      <v-btn
        v-if="props.showDetail"
        icon="mdi-chevron-right"
        size="small"
        @click="emit('click:detail', props.outsourcer)"
      />
    </v-card-actions>
  </v-card>
</template>
