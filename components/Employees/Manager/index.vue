<script setup>
const props = defineProps({ docs: { type: Array, default: () => [] }, search: { type: String, default: null }, hideDefaultFooter: Boolean, itemsPerPage: { type: Number, default: 5 }, showCreate: Boolean, sortBy: { type: Array, default: () => [] } });
