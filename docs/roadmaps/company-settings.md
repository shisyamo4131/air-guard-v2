...
- CCB-02 local release/parity調査: 2026-08-28完了。schemas/Admin SDKの変更surface、consumer順、create-only parity digest案を記録し、cross-repository local変更、staging/backup/audit/delete境界、Dev tenant分類はCONF-0139〜0144で承認待ち。
