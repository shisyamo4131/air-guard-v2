...
5. Employee master改修の現在工程・確認済み進捗・承認・次作業は[Employeeロードマップ](employee.md)、Local統合の実測は[EMP-08記録](../verification/employee-08-local.md)を正とする。Siteと進捗・完了条件・承認を合算せず、Dev反映・実dataへ承認を拡張しない。
