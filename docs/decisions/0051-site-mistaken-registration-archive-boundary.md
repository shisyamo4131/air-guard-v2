...
- 日付: 2026-09-05
- 状態: Accepted
- 一部置換: 2026-09-14の[ADR 0074](0074-transaction-parent-reference-independence.md)により、5つのトランザクションcollectionの参照確認と、トランザクションwriterのlive Site存在barrierを廃止した。archiveのactor・監査・同ID衝突防止は維持する。
