...
4マスターUIと配置管理の楽観的更新修正は完了した。次は[FUT-0185](future-actions.md#fut-0185-firestore-rulesの責務と式数を段階的に整理する)として、Firestore Rulesの責務と式数を段階的に整理する。入力component分離、tenant開放、Prod、pushは別承認とする。
