 ...
 * useCustomerBilling
 * @version 1.0.0
 * @description A data layer composable for customer billing details.
 * - Subscribes to customer billing document immediately.
...
/**
 * @param {*} options
 * @param {*} options.docId - The document ID of the CustomerBilling to subscribe to
 * @param {*} options.dateRangeComposable
 * @param {*} options.useDebounced - Whether to use debounced date range (default: false)
 * @returns {Object} - The customer billing data layer composable
 * @returns {Object} doc - Reactive CustomerBilling instance
 */
export function useCustomerBilling({ docId } = {}) {
