...
/*****************************************************************************
 * @function useOperationResultsInRange
 * @description 指定期間内の OperationResult インスタンスの配列を返すコンポーザブル
 * - `startDate` と `endDate` の範囲に含まれる OperationResult インスタンスを取得します。
 ...
 * @returns {Array<OperationResult>} - 指定期間内の OperationResult インスタンスの配列
 *****************************************************************************/
export function useOperationResultsInRange({ startDate, endDate } = {}) {
  /*****************************************************************************
   * SETUP LOGGER COMPOSABLE
   *****************************************************************************/
  const logger = useLogger("useOperationResultsInRange", useErrorsStore());
