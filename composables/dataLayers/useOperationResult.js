 ...
 * useOperationResult
 * @version 1.0.0
 * @description A data layer composable for operation result details.
 * - Subscribes to operation result document immediately.
...
/**
 * @param {*} options
 * @param {*} options.docId - The document ID of the OperationResult to subscribe to
 * @param {*} options.dateRangeComposable
 * @param {*} options.useDebounced - Whether to use debounced date range (default: false)
 * @returns {Object} - The operation result data layer composable
 * @returns {Object} doc - Reactive OperationResult instance
 */
export function useOperationResult({ docId } = {}) {
