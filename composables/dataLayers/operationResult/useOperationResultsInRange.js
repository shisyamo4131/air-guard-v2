...
/*****************************************************************************
 * @file ./composables/dataLayers/operationResult/useOperationResultsInRange.js
 * @description OperationResult range data layer composable.
 * @param {Object} options
 * @param {import("vue").Ref<Date>} options.from
 * @param {import("vue").Ref<Date>} options.to
 * @returns {{
 *   docs: import("vue").ComputedRef<OperationResult[]>
 * }}
 *****************************************************************************/
export function useOperationResultsInRange({ from, to } = {}) {
   ...
   * SETUP COMPOSABLES
   *****************************************************************************/
  const logger = useLogger("useOperationResultsInRange");
  const {
    fetchSiteComposable,
    fetchEmployeeComposable,
    fetchOutsourcerComposable,
  } = useFetch("useOperationResultsInRange");
