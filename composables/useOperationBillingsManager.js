/***************************************************************************
 * useOperationBillingsManager
 * @version 1.0.0
 * @description A composable to manage OperationBilling instances
...
export function useOperationBillingsManager({
   ...
   ***************************************************************************/
  const logger = useLogger("OperationBillingsManager", useErrorsStore());
  ...
  const attrs = Vue.computed(() => {
    return {
      ...
      onCreate: ($event) => router.push(`operation-billings/${$event.docId}`),
